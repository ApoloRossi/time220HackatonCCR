...
object MockDataUtil {
    ...
    fun getOficinasList() =
            listOf<OficinaView>(
                    OficinaView(
                            "Grafite - Oficio Cultura",
                            "Arte & Vida",
                            "A partir de diálogos com o público da Oficina Cultural e demais interessados neste trabalho, será construído de maneira coletiva um painel artístico. Moradores e comerciários também serão ouvidos em suas sugestões e críticas para o Coletivamente Hip Hop, grupo que irá realizar o grafite ao final. Com o objetivo de trazer alegria e irreverência, este espaço funcionará como vitrine cultural de uma construção realizada através do diálogo.",
                            "https://www.youtube.com/watch?v=i86P1947J7s",
                            "Grafite",
